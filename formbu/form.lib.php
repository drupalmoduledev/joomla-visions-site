<?php
# PHPFMG_ID:'20110815-5bd8'
# Date : 20110815 15:25:58
# Generated By Free PHP Formmail Generator : http://phpfmg.sourceforge.net
# -----------------------------------------------------------------------------


define( 'PAYPAL_ID' , '1NG74399F3369531F' ); // Put donation ID here to disable the copyright link

define( 'PHPFMG_TO' , 'universalvisions2010@gmail.com' );
define( 'PHPFMG_REDIRECT', 'http://universalvisions.net/thankyou.html' ); 

define( 'PHPFMG_ID' , '20110815-5bd8' ); 
...
define( 'PHPFMG_SUBJECT' , "Join Us" );
define( 'PHPFMG_CC' , '' );
define( 'PHPFMG_BCC', 'ibcann2005@hotmail.com' );
...
$GLOBALS['form_mail']['field_2'] = array( "name" => "field_2", "text" => "Core Interests",  "type" => "checkbox", "instruction" => "we are curious to know...", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_3'] = array( "name" => "field_3", "text" => "Male or Female",  "type" => "radio", "instruction" => "demographic insights", "required" => "" ) ;
...
function phpfmg_formini(){
    return "";
}
